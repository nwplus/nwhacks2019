  ...
  render() {
    ...
    return (
      <div className={`applicant-info pad-sides-s pad-ends-s ${className}`}>
        <CollapseSection label="Personal Info" open={open}>
        ...
        <CollapseSection label="Career Info" open={open}>
        ...
        <CollapseSection label="NwHacks Info" open={open}>
        ...
        <CollapseSection label="Long Answers" open={open}>
